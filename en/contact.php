...
<html class="no-js" lang="en">
  ...
  <body>
            ...
            <div class="small-12 columns">
                ...
                <div id="lang" class="right">
                    <ul class="inline-list">
                        ...
                        <li><a href="contact/php"><img src="../img/United-Kingdom.png" alt="English" /></a></li>
        ...
        <div class="small-12 columns">
            <nav>
                <ul class="inline-list">
                    ...
                    <li class="pozRel"><a href="#">Facilities <i class="fa fa-caret-down fa-lg mL5"></i></a>
                        <ul class="sub-menu">
                ...
                <div class="small-6 columns">
                    <div class="p20">
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="contactForm">
                            ...
                            <input type="submit" class="button radius tiny" name="submit" value="Send" />
                        </form>
                        <?php if(isset($hasError)) { //If errors are found ?>
                            <p class="error"><b>Error!</b></p>
                            <p class="error">Please check that you have correctly filled in all the mandatory fields. Thank you!</p>
                        <?php } ?>
                        <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
                            <p><b>Message sent successfully!</b></p>
                            <p>Thank you <b><?php echo $name;?></b> for your message! We will get back to you as soon as possible.</p>
                        <?php } ?>
                    </div>
                </div>
            </div>
    ...
    <footer>
        ...
        <div class="row">
            <div class="small-6 columns">
                <p class="small">&copy <span id="currentYear"></span> Vila Gong. All rights reserved.</p>
            </div>
            <div class="small-6 columns">
